...
from mask3d_models.resnet import ResNetBase, get_norm
from mask3d_models.modules.common import ConvType, NormType, conv, conv_tr
...
class MyRes16UNet14(Res16UNetBase):
    BLOCK = BasicBlock
    PLANES = (32, 64, 128, 256, 192, 128, 80, 64)
    LAYERS = (1, 1, 1, 1, 1, 1, 1, 1)

class MyRes16UNet18(Res16UNetBase):
    BLOCK = BasicBlock
    PLANES = (32, 64, 128, 256, 192, 128, 80, 64)
