...
from mask3d_models.misc import (is_dist_avail_and_initialized, nested_tensor_from_tensor_list)
...
class SetCriterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks, mask_type):
        ...
        for batch_id, (map_id, target_id) in enumerate(indices):
            ...
            # loss_dices.append(dice_loss(map, target_mask, num_masks))
        ...
        #         lambda logits: calculate_uncertainty(logits), self.num_points,
        ...
        #
        # losses = {"loss_mask": sigmoid_ce_loss_jit(point_logits, point_labels, num_masks, mask_type),
