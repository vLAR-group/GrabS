...
class Trainer(object):
    def __init__(self, model, objnet, PPO_actor, PPO_critic, logger, train_dataset, val_dataset, val_RL_dataset, save_path, cfg=None, use_norm=True, use_label=False):
        ...
        ## diffusion
        ### DDPM parameters
        self.num_timesteps = cfg.max_diff_steps
        self.betas = linear_beta_schedule(self.num_timesteps).cuda()
        ...
        for iter in range(iters+1):
            ...
            with torch.no_grad():
                ...
                while head < len(valid_traj_id_tmp):
                    ...
                    embedd = [self.ddim_sample(cond_feat), pred_R_inv]
    ...
    def ddim_sample(self, cond):
        ...
        for i in range(1, self.ddim_sampling_timesteps):
            ...
            pred_x0 = self.objnet.diffusion_net(x_T, cond, batch_t.float())
