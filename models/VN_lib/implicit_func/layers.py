...
class ResnetBlockBNFC(nn.Module):
    ''' Fully connected ResNet Block class.
    ...
    def forward(self, x):
        ...
        net = self.fc_0(self.actvn(self.bn_0(x.transpose(2, 1))).transpose(2, 1))
        dx = self.fc_1(self.actvn(self.bn_1(net.transpose(2, 1))).transpose(2, 1))
