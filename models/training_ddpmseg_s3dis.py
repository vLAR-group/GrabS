...
class Trainer(object):
    ...
    def validation(self, vis=True, log=False):
        ...
        for batch_idx, batch in enumerate(val_data_loader):
            ...
            # self.preds[scene_name[0]] = {"pred_masks": valid_masks, "pred_scores": (masks*hard_masks).mean(0), "pred_classes": torch.zeros(valid_masks.shape[-1])}
